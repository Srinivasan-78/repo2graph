# Threat model and deployment security guide
...
[`.github/SECURITY.md`](../.github/SECURITY.md), [`docs/PRIVACY.md`](PRIVACY.md) and
[`docs/ENTERPRISE_DEPLOYMENT.md`](ENTERPRISE_DEPLOYMENT.md) already establish — it cites them and
adds the piece none of them state explicitly: a trust boundary per mode, and a verdict on each.
